(() => {
    ...
    function initSliders() {
        if (document.querySelector(".customers__slider")) new core(".customers__slider", {
            ...
            loop: true,
            pagination: {
                el: ".customers__slider .swiper-pagination",
                clickable: true
            },
            navigation: {
    ...
    const videoSound = document.querySelector(".video__sound");
    if (videoBtn) videoBtn.addEventListener("click", (function(e) {
        function toggleOverlay(event) {
            if ("mouseleave" === event.type) videoOverlay.classList.add("hidden"); else videoOverlay.classList.remove("hidden");
        }
        if (videoFile.paused) {
            videoFile.play();
            videoIcon.src = "img/icons/svgicons/pause.svg";
            ...
            videoIcon.src = "img/icons/svgicons/play.svg";
            videoOverlay.onmouseleave = null;
            videoOverlay.onmouseenter = null;
        }
        if (videoFile.muted) videoSound.src = "img/icons/svgicons/sound_off.svg"; else videoSound.src = "img/icons/svgicons/sound.svg";
    }));
    const officeIsrael = document.querySelector(".contacts-offices__item.Israel");
    const officeKyiv = document.querySelector(".contacts-offices__item.Kyiv");
    const imageBox = document.querySelector(".contacts-offices__image-box");
    if (officeIsrael) officeIsrael.addEventListener("click", (function(e) {
        officeIsrael.classList.add("_active");
        officeKyiv.classList.remove("_active");
        imageBox.classList.contains("_rotate") ? imageBox.classList.remove("_rotate") : null;
    }));
    if (officeKyiv) officeKyiv.addEventListener("click", (function(e) {
        officeKyiv.classList.add("_active");
        officeIsrael.classList.remove("_active");
        imageBox.classList.add("_rotate");
    }));
    window["FLS"] = true;
    isWebp();
    addLoadedClass();
